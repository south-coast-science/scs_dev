...
class CmdSN(object):
    ...
    def __init__(self):
        ...
        # compulsory...
        self.__parser.add_option("--sn", "-s", type="int", nargs=1, action="store", dest="sn", help="sensor number (1 to 4)")

        # optional...
        self.__parser.add_option("--interval", "-i", type="float", nargs=1, action="store", dest="interval", default=1.0, help="sampling interval in seconds (default 1.0)")
